...
<header class="header">
            ...
            <div class="col-12">
                <div class="text-center">
                    <a href="<?php echo site_url('/'); ?>">
                        ...
                        ?>
                                <img  class="logo" src="<?php echo get_template_directory_uri(); ?>/img/logo_mineco.png" alt="logo">
	                    <?php
                            }
                        ?>
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
						...
						if($id_user['Profile'] === 'genero'){
							$args = array(
								...
								'container'      => '',
								'menu_class'     => 'navbar-nav mr-auto menu-principal' . (is_front_page() ? ' menu-principal-home ' : ' menu-principal-all'),
							);
							wp_nav_menu( $args );
                        }else{
							$args = array(
    ...
    ?>
        <div class="tagline text-center container">
            <h1 class="ml2">
                <?php the_field('encabezado_titulo'); ?>
            </h1>
            <p><?php the_field('encabezado_texto'); ?></p>
        </div>
    <?php }?>
</header>
